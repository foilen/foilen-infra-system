...
public class CommonResourceLinkTest {
    ...
    public CommonResourceLinkTest() {
        ...
        commonServicesContext = resourceServicesInMemoryImpl.getCommonServicesContext();
        internalServicesContext = resourceServicesInMemoryImpl.getInternalServicesContext();
    }

    private EmployeeResource getEmployee(String firstName) {
        return resourceServicesInMemoryImpl.resourceFind( //
                resourceServicesInMemoryImpl.createResourceQuery(EmployeeResource.class) //
    ...
    public void testFillResourceLink_Change() {
        ...
        ChangesContext changesContext = new ChangesContext(resourceServicesInMemoryImpl);
        ...
        resourceServicesInMemoryImpl.getInternalServicesContext().getInternalChangeService().changesExecute(changesContext);
